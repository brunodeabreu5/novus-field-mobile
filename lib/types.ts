...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      ...
      // Note: visit_type is NOT an enum - it's a string that references VisitTypeOption.name
      // The valid values are managed dynamically in the visit_type_options table
    };
    CompositeTypes: {
      [_ in never]: never;
    };
...
export const Constants = {
  public: {
    Enums: {
      app_role: ["admin", "manager", "vendor"],
      // visit_type values are dynamic - managed in visit_type_options table
    },
  },
} as const;
