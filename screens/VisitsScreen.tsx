...
const styles = StyleSheet.create({
  ...
  visitHeader: { flexDirection: "row", justifyContent: "space-between", gap: 8 },
  visitClient: { fontSize: 16, fontWeight: "600", color: colors.foreground, flex: 1 },
  ...
  secondaryButtonText: { fontSize: 13, color: colors.foreground, fontWeight: "600" },
  attachmentsRow: { marginTop: 12 },
  attachmentCard: {
    width: 92,
    height: 92,
    marginRight: 10,
  ...
  documentAttachmentIcon: { fontSize: 12, fontWeight: "700", color: colors.primary },
  documentAttachmentName: { fontSize: 12, color: colors.foreground, textAlign: "center" },
  modal: {},
  ...
  clientModeText: { fontSize: 12, color: colors.foreground, fontWeight: "600" },
  clientModeTextActive: { color: "#fff" },
  attachmentButtonsRow: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: 12 },
